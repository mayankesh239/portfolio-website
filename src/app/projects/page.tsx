...
//     description: "Real-time embedded applications on STM32 Nucleo-F401RE using STM32CubeIDE, FreeRTOS, and CMSIS-RTOS API. Demonstrated mutexes, semaphores, queues, task scheduling, inter-task communication, and GPIO synchronization.",
...
//     description: "Built multiple Arduino-based embedded systems including 7-segment counter, LED blinker, PWM brightness control, and buzzer-LED alarm systems to reinforce sensor-based event handling and microcontroller programming.",
...
//     description: "A Python application that fetches PII patterns from a GitHub repository and synchronizes them with a MongoDB collection, aiding in data privacy and compliance.",
//     technologies: ["Python", "MongoDB", "GitHub API", "Cron Jobs"],
//     url: "https://github.com/mayankesh239/PII_Tracker",
//     liveUrl: "", // Not applicable for this project
//     image: "/PII.png", // Replace with actual image path
//   },  
//   {
//     title: "MatrixMart",
//     description: "Full-fledged e-commerce web application using Node.js, Express.js, RESTful API, Redux, React.js, and MongoDB.",
...
//     description: "Website for Jharkhand Science and Environment Festival (JSEF) ’22, built using TypeScript and Next.js for EPAC, BIT Mesra.",
...
//     description: "A decentralized application (DApp) built on the Ethereum blockchain, enabling users to buy and sell coffee beans directly, ensuring transparency and traceability in every transaction.",
//     technologies: ["Solidity", "Hardhat", "Ethers.js", "React", "Tailwind CSS", "Vercel", "Netlify"],
...
//     description: "A real-time cryptocurrency price tracker built with React.js, utilizing the CoinGecko API for up-to-date market data.",
...
//             className="bg-white rounded-3xl shadow-2xl overflow-hidden hover:shadow-3xl transform hover:scale-105 transition-all duration-500 cursor-pointer flex flex-col"
//           >
//             {/* Project Image */}
...
//                   <span
//                     key={tech}
//                     className="text-sm px-3 py-1 bg-blue-100 text-blue-800 rounded-full font-medium shadow-sm"
//                   >
//                     {tech}
//                   </span>
//                 ))}
